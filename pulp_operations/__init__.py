...
from pulp_operations.repository import get_repo, get_repoversion, create_repo, list_repo, delete_repo
...
from pulp_operations.distribution import update_distribution, create_distribution, list_distribution
